...
class Announce(DefaultModel):
    ...
    writer = models.ForeignKey(User, on_delete=models.PROTECT, related_name='announces')
    ...
    cutoff = models.DateTimeField(null=True)     #실마감날짜
...
class Comment(DefaultModel):
    ...
    writer = models.ForeignKey(User, on_delete=models.PROTECT, related_name='comments')
